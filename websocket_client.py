...
''' Created on Apr 1, 2016 @author: Guijie Wang / 王桂杰 '''
...
class WebSocketClient(object):
    ...
    def connect(self, url):
        """Connect to the server. :param str url: server URL. """
    ...
    def send(self, data):
        """Send message to the server :param str data: message. """
    ...
    def on_message(self, msg):
        """This is called when new message is available from the server. :param str msg: server message. """
